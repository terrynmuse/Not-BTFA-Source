...
{
    public class PlanewalkerGuardianYellow : ModNPC
    {
		Vector2 Location;
		Vector2 Location2;
        ...
        public override void AI()
        {
            ...
            {
                if ((npc.active && player.active && (double) Vector2.Distance(player.Center, npc.Center) <= (double) distance) && shootTimer >= 160)
                {
					...
					int damage = 10; 
					int type = mod.ProjectileType("YellowBlast"); 
